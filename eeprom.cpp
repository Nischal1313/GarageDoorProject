...
//When we read a boolean or a larger int of the steps for the stepper motor for example.
...
//When we write a boolean or a larger int of the steps for the stepper motor for example.
